...
// Enqueue Color Picker
 ...
 function icpe_pallete_script() {
 	...
 	wp_enqueue_script('wp-color-picker-alpha', ICPE_PLUGIN_URI . 'assets/js/wp-color-picker-alpha.min.js', array( 'jquery', 'wp-color-picker' ), null, true);
...
is_admin() && add_filter( 'gettext',
    function( $translated_text, $untranslated_text, $domain )
    {
        ...
        $new = "Plugin activated. <a href='" .$path_link."options-general.php?page=iris-color-picker-enhancer'>Go to Iris Color Picker Enhancer Settings.</a> ";
